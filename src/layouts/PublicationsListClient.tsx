      ...
      >
        <div className="relative">
          {metadata?.image ? (
            <Image
              src={metadata.image}
              alt={`Publication ${notionTitle} par VIRY Brandon sur ${platform.name} - Contenu tech sur le développement web, React et Next.js`}
              width={1080}
              height={720}
            ...
            <div className="w-full h-48 bg-gradient-to-br from-gray-800 to-gray-900 flex items-center justify-center">
              <svg className="w-16 h-16 text-gray-700" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-label="Image placeholder pour publication">
